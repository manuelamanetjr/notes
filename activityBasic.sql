...
ORDER BY CHECK_OUT_DATE DESC, BOOK_NUM DESC 
LIMIT 10;
...
////////////////////////////////////////////////////////////////////////////
D:\Downloads\record_backup.tar

SELECT *, SKILL.STUD_ID
FROM STUDENT INNER JOIN skill USING (STUD_ID);

SELECT *, SKILL.STUD_ID
FROM STUDENT LEFT JOIN SKILL USING(STUD_ID);

SELECT *, SKILL.STUD_ID
FROM STUDENT FULL OUTER JOIN SKILL USING(STUD_ID);

SELECT *, SKILL.STUD_ID
FROM STUDENT CROSS JOIN SKILL ;
...
ORDER TOTAL NUMERIC (10,2),

CUST_ID

INT

NOT NULL REFERENCES CUSTOMER ON DELETE CASCADE ON UPDATE CASCADE

CREATE TABLE CUSTOMER LOG (

CT_LOG_ID SERIAL

PRIMARY KEY,

CT_LOG_DATE TIMESTAMP
